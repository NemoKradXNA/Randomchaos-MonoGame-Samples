...
namespace RandomchaosMGBase.Noise
{
    public class FractalNoiseGenerator
    {
        ...
        public FractalNoiseGenerator(INoise noise, int octaves, float frequency, float amplitude = 1.0f)
        {
        ...
        public FractalNoiseGenerator(INoise[] noises, int octaves, float frequency, float amplitude = 1.0f)
        {
